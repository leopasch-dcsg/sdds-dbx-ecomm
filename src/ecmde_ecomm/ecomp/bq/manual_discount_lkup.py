...
class ManualDiscountLkupEgressOperation(BigQueryEgressOperation):
    ...
    def get_source_dataframe(
        ...
        return df.select(
            col("MANUAL_DISC_KEY").cast(DecimalType(38, 0)).alias("manual_disc_key"),
            col("MANUAL_DISC_DESC").cast(StringType()).alias("manual_disc_desc"),
            date_format(
                convert_timezone(
