...
dbx_loader.execute_mysql_sp_pymysql("ecom.sp_upsert_content_worklist_sku_pordr")
end_time = time.time()

print(f"Total execution time: {end_time - start_time} seconds")

start_time = time.time()
dbx_loader.execute_mysql_sp_pymysql("ecom.sp_upsert_content_worklist_sku_inventory")
end_time = time.time()

print(f"Total execution time: {end_time - start_time} seconds")

start_time = time.time()
dbx_loader.execute_mysql_sp_pymysql("ecom.sp_update_content_worklist_sku_vdc_from_stage")
end_time = time.time()
