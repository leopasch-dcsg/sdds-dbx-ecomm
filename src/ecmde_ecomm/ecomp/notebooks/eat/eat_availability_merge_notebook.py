...
from ecmde_ecomm.ecomp.eat.eat_merge_operations_provider import (
    EatMergeOperationsProvider,
)
...
try:
    ...
    result = (
        EatMergeOperationsProvider.provider(config, watermark, spark)
    ...
    print(
        f"""
        Processing complete.
        Data Quality: {data_quality.value}
