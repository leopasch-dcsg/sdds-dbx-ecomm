...
from ecmde_ecomm.search.ltr.ltr_dbx_to_kafka import LtrKafkaProducer
...
producer = LtrKafkaProducer(spark, config, watermark, source_table_name)
result = producer.produce(["partnumber"])
